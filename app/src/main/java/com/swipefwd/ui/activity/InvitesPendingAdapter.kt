...
class InvitesPendingAdapter(val context: Context) :
    RecyclerView.Adapter<InvitesPendingAdapter.MyHolder>(), Filterable {
    inner class MyHolder(val binding: ItemActivityHorizontalBinding) :
        RecyclerView.ViewHolder(binding.root)

    private var usersList = ArrayList<ActiveExpireRequestListModel.Pending>()
