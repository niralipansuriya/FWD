...
class MaterialTextDrawable2 constructor(builder: Builder) {
    ...
    class Builder {
        ...
        fun backgroundHandle(displayBackgroundWhite: Boolean) : Builder {
            MaterialTextDrawable2.displayBackgroundWhite = displayBackgroundWhite
            return this
        }
        ...
        fun get(): BitmapDrawable {
            ...
            return MaterialTextDrawable2(this).getTextDrawable()
        }
