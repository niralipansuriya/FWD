...
class DottedCircularProgress {
    ...
    class TrailingCircularDotsLoader : LinearLayout, LoaderContract {
        ...
        var circleColor = arrayOf(resources.getColor(R.color.dot2),resources.getColor(R.color.dot3),resources.getColor(R.color.dot4),resources.getColor(R.color.dot5))
        var noOfTrailingDots: Int = 4
        ...
        constructor(context: Context?, dotsRadius: Int, circleColor: Int, bigCircleRadius: Int, noOfTrailingDots: Int) : super(context) {
            ...
            this.circleColor = arrayOf(circleColor)
...
//            this.circleColor = arrayOf(
//                typedArray.getColor(R.styleable.TrailingCircularDotsLoader_trailingcircular_dotsColor,
//                    arrayOf(resources.getColor(R.color.dot1),resources.getColor(R.color.dot2),resources.getColor(R.color.dot3),resources.getColor(R.color.dot4),resources.getColor(R.color.dot5)))
//            )
        ...
        private fun initView() {
            ...
            mainCircle = CircleView(context, dotsRadius, resources.getColor(R.color.dot1))
            ...
            for (i in 0 until noOfTrailingDots) {
                val circle = CircleView(context, dotsRadius, circleColor[i])
