...
class SquareProgressView : View {
    ...
    private var percentSettings: PercentStyle = PercentStyle(
        Align.CENTER, 150f,
        true
    )
    ...
    private fun initializePaints(context: Context) {
        ...
        progressBarPaint!!.color = ContextCompat.getColor(context, android.R.color.holo_green_dark)
