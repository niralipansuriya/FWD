package com.swipefwd.utils.segmentedButtonTemp;
...
public class SegmentedButtonGroup2 extends LinearLayout
{
    ...
    public SegmentedButtonGroup2(Context context)
    {
        super(context);
    ...
    public SegmentedButtonGroup2(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public SegmentedButtonGroup2(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    public SegmentedButtonGroup2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params)
    {
        if (child instanceof SegmentedButton)
        {
            ...
            button._setOnVisibilityChangedListener((button1, visibility) -> {
                ...
                // otherwise)
                final int index1 = SegmentedButtonGroup2.this.buttonLayout.indexOfChild(button1);
                SegmentedButtonGroup2.this.dividerLayout.getChildAt(index1).setVisibility(visibility);
