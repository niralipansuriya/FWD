...
public class SegmentedButton extends View
{
    ...
    private com.swipefwd.utils.segmentedButtonTemp.SegmentedButton.OnVisibilityChangedListener onVisibilityChangedListener;
...
//        );
        int arr[] = new int[2];
        arr[0]=Color.parseColor("#6C67EF");
        arr[1]=Color.parseColor("#5EA3FB");
        Shader shader;
...
//        textPaint.setShader(shader);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (hasText)
        {
                    float widthText = textPaint.measureText(
               text
        );
            int arr[] = new int[2];
            arr[0]=Color.parseColor("#6C67EF");
