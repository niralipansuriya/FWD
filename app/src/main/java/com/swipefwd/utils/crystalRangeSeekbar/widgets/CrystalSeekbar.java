package com.swipefwd.utils.crystalRangeSeekbar.widgets;
...
import com.swipefwd.utils.crystalRangeSeekbar.interfaces.OnSeekbarFinalValueListener;
...
//    public void setSelectedMinValue(float val){
//        double nv = val;
...
//    }
    ...
    protected final int getPosition(final TypedArray typedArray) {
        final int pos = typedArray.getInt(R.styleable.CrystalSeekbar_seekbar_position, Position.LEFT);
