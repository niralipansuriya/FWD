...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    public static final int ALIGN_CENTER = 0, ALIGN_LEFT = 1, ALIGN_RIGHT = 2, SHIFT_RIGHT = 3, SHIFT_LEFT = 4;
    ...
    private int mItemTextColor, mSelectedItemTextColor, mSelectedItemTextSize;
    ...
    private boolean wheel_custom_paddingTop;
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mData = Arrays.asList(getResources()
                .getStringArray(idData == 0 ? R.array.picker_month : idData));
        ...
        mSelectedItemTextSize = a.getColor
                (R.styleable.WheelPicker_wheel_selected_item_text_color, 16);
        ...
        wheel_custom_paddingTop = a.getBoolean(R.styleable.WheelPicker_wheel_custom_paddingTop, false);
        ...
        //mPaint.setTypeface(ResourcesCompat.getFont(context, R.font.medium));
    ...
    private void computeDrawnCenter() {
        switch (mItemAlign) {
            ...
            case ALIGN_RIGHT:
                ...
                break;
            case SHIFT_RIGHT:
                mDrawnCenterX = mRectDrawn.right-170;
                break;
            case SHIFT_LEFT:
                mDrawnCenterX = mRectDrawn.left+170;
                break;
            default:
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int drawnDataPos = drawnDataStartPos + mSelectedItemPosition,
            ...
            if (isCurved) {
                ...
                float degree = (-(1 - ratio) * 60 * unit);  // earlier 90 degree
                ...
                switch (mItemAlign) {
                    ...
                    case ALIGN_RIGHT:
                        ...
                        break;
                    case SHIFT_RIGHT:
                        transX = mRectDrawn.right-170;
                        break;
                    case SHIFT_LEFT:
                        transX = mRectDrawn.left+170;
                        break;
                }
                ...
                if(wheel_custom_paddingTop)
                mMatrixRotate.postTranslate(transX, transY+8); // added 8 to slightly move view vertically
               else
                mMatrixRotate.postTranslate(transX, transY); // added 8 to slightly move view vertically
              ...
              //  mMatrixDepth.postTranslate(transX, transY);
                /*if(wheel_custom_paddingTop)
                    mMatrixDepth.postTranslate(transX, transY);  // added 8 to slightly move view vertically
                else*/
                    mMatrixDepth.postTranslate(transX, transY);
    ...
    public int getmSelectedItemTextSize() {
        return mSelectedItemTextSize;
    }

    public void setmSelectedItemTextSize(int mSelectedItemTextSize) {
        this.mSelectedItemTextSize = mSelectedItemTextSize;
        invalidate();
    }
