...
class WheelDatePicker extends LinearLayout implements WheelPicker.OnItemSelectedListener,
...
/*  mTVYear = (TextView) findViewById(R.id.wheel_date_picker_year_tv);
  ...
  mTVDay = (TextView) findViewById(R.id.wheel_date_picker_day_tv);*/
    ...
    public void onItemSelected(WheelPicker picker, Object data, int position) {
        if (picker.getId() == R.id.pickerYear) {
            mYear = (int) data;
            mPickerDay.setYear(mYear);
        } else if (picker.getId() == R.id.pickerMonth) {
            mMonth = (int) data;
    ...
    public void setSelectedItemTextSize(int size) {
        mPickerYear.setSelectedItemTextSize(size);
        mPickerMonth.setSelectedItemTextSize(size);
        mPickerDay.setSelectedItemTextSize(size);
    }
