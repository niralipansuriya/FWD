...
public final class DialogBlockedBinding implements ViewBinding {
  @NonNull
  ...
  private DialogBlockedBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialButton btnGotIt,
  ...
  @NonNull
  public static DialogBlockedBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogBlockedBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_blocked, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogBlockedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogBlockedBinding((ConstraintLayout) rootView, btnGotIt, imgDialogGradient,
