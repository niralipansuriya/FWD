...
public final class DialogDisableDaterBinding implements ViewBinding {
  @NonNull
  ...
  private DialogDisableDaterBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static DialogDisableDaterBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogDisableDaterBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_disable_dater, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogDisableDaterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogDisableDaterBinding((ConstraintLayout) rootView, btnCancel, btnYes,
