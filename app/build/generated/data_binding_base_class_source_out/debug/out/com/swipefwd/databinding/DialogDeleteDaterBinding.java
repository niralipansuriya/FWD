...
public final class DialogDeleteDaterBinding implements ViewBinding {
  @NonNull
  ...
  private DialogDeleteDaterBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull LinearLayout layoutConfirm, @NonNull MaterialButton txtDontShow) {
  ...
  @NonNull
  public static DialogDeleteDaterBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogDeleteDaterBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_delete_dater, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogDeleteDaterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogDeleteDaterBinding((ConstraintLayout) rootView, btnCancel, btnYes,
          cardBottom, imgDialogGradient, layoutConfirm, txtDontShow);
    }
