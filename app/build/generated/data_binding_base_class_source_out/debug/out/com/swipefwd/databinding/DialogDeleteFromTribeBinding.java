...
public final class DialogDeleteFromTribeBinding implements ViewBinding {
  @NonNull
  ...
  private DialogDeleteFromTribeBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static DialogDeleteFromTribeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogDeleteFromTribeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_delete_from_tribe, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogDeleteFromTribeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogDeleteFromTribeBinding((ConstraintLayout) rootView, btnDeleteCancel,
