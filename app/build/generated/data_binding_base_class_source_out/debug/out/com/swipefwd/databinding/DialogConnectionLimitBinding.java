...
public final class DialogConnectionLimitBinding implements ViewBinding {
  @NonNull
  ...
  private DialogConnectionLimitBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnContinue, @NonNull MaterialButton btnHome,
  ...
  @NonNull
  public static DialogConnectionLimitBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogConnectionLimitBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_connection_limit, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogConnectionLimitBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogConnectionLimitBinding((ConstraintLayout) rootView, btnContinue, btnHome,
