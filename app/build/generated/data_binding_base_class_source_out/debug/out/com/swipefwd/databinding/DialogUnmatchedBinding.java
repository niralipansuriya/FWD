...
public final class DialogUnmatchedBinding implements ViewBinding {
  @NonNull
  ...
  private DialogUnmatchedBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static DialogUnmatchedBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogUnmatchedBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_unmatched, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogUnmatchedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogUnmatchedBinding((ConstraintLayout) rootView, btnGotIt, imgDialogGradient,
