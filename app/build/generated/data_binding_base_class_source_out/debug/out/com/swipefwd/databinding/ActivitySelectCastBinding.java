...
public final class ActivitySelectCastBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextInputEditText edtCast;
  ...
  private ActivitySelectCastBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialCardView cardList, @NonNull TextInputEditText edtCast,
      @NonNull AppCompatImageView ivClose, @NonNull RecyclerView rcvCast,
  ...
  @NonNull
  public static ActivitySelectCastBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySelectCastBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_select_cast, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySelectCastBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.edtCast;
      TextInputEditText edtCast = ViewBindings.findChildViewById(rootView, id);
      if (edtCast == null) {
        break missingId;
      }
      ...
      return new ActivitySelectCastBinding((ConstraintLayout) rootView, cardList, edtCast, ivClose,
          rcvCast, txtIndex, txtSkip, txtSubmit, txtTitle);
    }
