...
public final class DialogDisableConnectorBinding implements ViewBinding {
  @NonNull
  ...
  private DialogDisableConnectorBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static DialogDisableConnectorBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogDisableConnectorBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_disable_connector, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogDisableConnectorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogDisableConnectorBinding((ConstraintLayout) rootView, btnCancel, btnYes,
