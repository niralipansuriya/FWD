...
public final class DialogFinalGestureBinding implements ViewBinding {
  @NonNull
  ...
  private DialogFinalGestureBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialCardView cardGesture, @NonNull ImageView imageView,
      @NonNull AppCompatImageView imgDialogGradient, @NonNull MaterialCardView materialCardView2,
      @NonNull RelativeLayout pullDown, @NonNull AppCompatTextView txtCopyGesture,
      @NonNull AppCompatTextView txtDesc, @NonNull MaterialButton txtRetake,
      @NonNull MaterialButton txtSubmit, @NonNull AppCompatImageView viewUserImage) {
  ...
  @NonNull
  public static DialogFinalGestureBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogFinalGestureBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_final_gesture, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogFinalGestureBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogFinalGestureBinding((ConstraintLayout) rootView, cardGesture, imageView,
          imgDialogGradient, materialCardView2, pullDown, txtCopyGesture, txtDesc, txtRetake,
          txtSubmit, viewUserImage);
    }
