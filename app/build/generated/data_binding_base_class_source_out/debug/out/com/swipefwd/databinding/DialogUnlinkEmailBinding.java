...
public final class DialogUnlinkEmailBinding implements ViewBinding {
  @NonNull
  ...
  private DialogUnlinkEmailBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static DialogUnlinkEmailBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogUnlinkEmailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_unlink_email, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogUnlinkEmailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogUnlinkEmailBinding((ConstraintLayout) rootView, btnCancel, btnYes,
