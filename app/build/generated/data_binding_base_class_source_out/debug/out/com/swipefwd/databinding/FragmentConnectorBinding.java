...
public final class FragmentConnectorBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentConnectorBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static FragmentConnectorBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentConnectorBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_connector, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentConnectorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentConnectorBinding((LinearLayout) rootView, txtHome, txtOnBoarding,
          txtSwiping);
    }
