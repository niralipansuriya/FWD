...
public final class DialogUnlinkFbBinding implements ViewBinding {
  @NonNull
  private final ConstraintLayout rootView;

  @NonNull
  public final MaterialButton btnFbCancel;

  @NonNull
  public final MaterialButton btnFbYes;
  ...
  private DialogUnlinkFbBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnFbCancel, @NonNull MaterialButton btnFbYes,
    ...
    this.btnFbCancel = btnFbCancel;
    this.btnFbYes = btnFbYes;
  ...
  @NonNull
  public static DialogUnlinkFbBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogUnlinkFbBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_unlink_fb, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogUnlinkFbBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btnFbCancel;
      MaterialButton btnFbCancel = ViewBindings.findChildViewById(rootView, id);
      if (btnFbCancel == null) {
        break missingId;
      }

      id = R.id.btnFbYes;
      MaterialButton btnFbYes = ViewBindings.findChildViewById(rootView, id);
      if (btnFbYes == null) {
        break missingId;
      }
      ...
      return new DialogUnlinkFbBinding((ConstraintLayout) rootView, btnFbCancel, btnFbYes,
