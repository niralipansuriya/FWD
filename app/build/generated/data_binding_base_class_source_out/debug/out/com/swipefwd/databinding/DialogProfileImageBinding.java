...
public final class DialogProfileImageBinding implements ViewBinding {
  @NonNull
  ...
  private DialogProfileImageBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnFillProfile, @NonNull MaterialButton btnNotNow,
      @NonNull AppCompatImageView imgDialogGradient, @NonNull TextView txtMessage1,
      @NonNull TextView txtMessage2) {
    this.rootView = rootView;
    this.btnFillProfile = btnFillProfile;
  ...
  @NonNull
  public static DialogProfileImageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogProfileImageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_profile_image, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogProfileImageBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btnFillProfile;
      MaterialButton btnFillProfile = ViewBindings.findChildViewById(rootView, id);
      if (btnFillProfile == null) {
        break missingId;
      }
      ...
      return new DialogProfileImageBinding((ConstraintLayout) rootView, btnFillProfile, btnNotNow,
