...
public final class DialogDeleteAccount2Binding implements ViewBinding {
  @NonNull
  ...
  private DialogDeleteAccount2Binding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static DialogDeleteAccount2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DialogDeleteAccount2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_delete_account2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogDeleteAccount2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogDeleteAccount2Binding((ConstraintLayout) rootView, btnDeleteCancel,
