...
public final class ActivityWelcomeBinding implements ViewBinding {
  ...
  private ActivityWelcomeBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnContinue, @NonNull MaterialButton btnSkip,
      @NonNull CircleIndicator layoutIndicator, @NonNull ViewPager pagerIntro) {
    this.rootView = rootView;
    this.btnContinue = btnContinue;
    this.btnSkip = btnSkip;
    this.layoutIndicator = layoutIndicator;
    this.pagerIntro = pagerIntro;
  }
  ...
  public static ActivityWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.pagerIntro;
      ViewPager pagerIntro = ViewBindings.findChildViewById(rootView, id);
      if (pagerIntro == null) {
        break missingId;
      }

      return new ActivityWelcomeBinding((ConstraintLayout) rootView, btnContinue, btnSkip,
          layoutIndicator, pagerIntro);
    }
