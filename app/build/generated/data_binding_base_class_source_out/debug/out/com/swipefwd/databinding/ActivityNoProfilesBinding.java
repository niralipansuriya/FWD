...
public final class ActivityNoProfilesBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityNoProfilesBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnGotIt, @NonNull AppCompatImageView imgChat,
      ...
      @NonNull TextView txt1, @NonNull TextView txt2, @NonNull TextView txtBadge) {
  ...
  @NonNull
  public static ActivityNoProfilesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityNoProfilesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_no_profiles, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityNoProfilesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNoProfilesBinding((ConstraintLayout) rootView, btnGotIt, imgChat, imgHome,
          imgUser, ivLogo, layoutHeader, txt1, txt2, txtBadge);
    }
