...
public class CountryPicker implements BottomSheetInteractionListener, LifecycleObserver {
  ...
  // if any change in TOPCOUNTRIES then also change in CountryAdapter
  public static final Country[] TOPCOUNTRIES ={
   ...
   public static final Country[] COUNTRIES = {
    ...
    //  new Country("AQ", "Antarctica", "+672", R.drawable.flag_aq, "USD"),
     ...
     // new Country("CC", "Cocos Islands", "+61", R.drawable.flag_cc, "AUD"),
      ...
      new Country("DO", "Dominican Republic", "+1-809", R.drawable.flag_do, "DOP"),
      new Country("DO", "Dominican Republic", "+1-829", R.drawable.flag_do, "DOP"),
     ...
     // new Country("PN", "Pitcairn", "+64", R.drawable.flag_pn, "NZD"),
      new Country("PR", "Puerto Rico", "+1-787", R.drawable.flag_pr, "USD"),
  ...
  private List<Country> totalcountries = new ArrayList<Country>();
  ...
  CountryPicker(Builder builder) {
    ...
    totalcountries.addAll(Arrays.asList(TOPCOUNTRIES));
    totalcountries.addAll(Arrays.asList(COUNTRIES));
  ...
  public Country getCountryByISO(@NonNull String countryIsoCode) {
    Collections.sort(totalcountries, new ISOCodeComparator());
    Country country = new Country();
    country.setCode(countryIsoCode);
    int i = Collections.binarySearch(totalcountries, country, new ISOCodeComparator());
    if (i < 0) {
      return null;
    } else {
      return totalcountries.get(i);
    }
  }
